...
const Footer = () => {
    return (
        <div className='row'>
            <h2 className='col-12 text-center text-dark mt-4'>NAGU SAABSAN</h2>
            <div className='col-12 d-flex justify-content-center mt-3'>
                <small className='text-center w-50'>Ganacsiga Online-ka ah ayaa isbeddel ku keenaya dhammaan sida looga adeegto
            ...
            <div className='col-12 bg-red-darken d-flex justify-content-around text-center p-2 mt-5'>
                ...
                <div className='d-flex flex-column justify-content-around align-items-center text-white'>
                    ...
                    <p className='fw-bold mt-1'>QAADISTU WAA BILAASH</p>
                </div>
            ...
            <div className='col-12 row row-cols-2 justify-content-between bg-red text-white py-3 px-5'>
                <div className='col'>
            ...
            <div className='col-12 bg-red text-white text-center pb-3'>
                <p className='fw-bold' style={{fontSize: '20px'}}>Follow Us On</p>
